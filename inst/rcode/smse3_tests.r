sim.smse3 <- function(lambda=10,kappa=.08,snr=100,ngrad=42,n=10,scenario=1,graph=TRUE){
require(dti)
...
zmix12 <- dwiMtImprove(zmix12,z$zsm12,maxcomp=maxcomp)
zmix12 <- dwiMtImprove(zmix12,z$zsm12,maxcomp=maxcomp)
zmix15 <- dwiMixtensor(zsm15,maxcomp=maxcomp)
zmix15 <- dwiMtImprove(zmix15,zsm15,maxcomp=maxcomp)
zmix15 <- dwiMtImprove(zmix15,zsm15,maxcomp=maxcomp)
zmix15 <- dwiMtImprove(zmix15,zsm15,maxcomp=maxcomp)
zmix15 <- dwiMtImprove(zmix15,zsm15,maxcomp=maxcomp)
